...
def read_logs():
    ...
    The function reads log entries from "logs.txt", calculates the time difference between each log entry's timestamp
    ...
    with open("logs.txt", "r") as r:
        ...
        for line in reversed(lines):
            ...
            if dif < 19407:  # 19407 seconds is approximately 5 hours and 23 minutes
